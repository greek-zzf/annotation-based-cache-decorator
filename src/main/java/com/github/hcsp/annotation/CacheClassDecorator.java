...
public class CacheClassDecorator {
    ...
    public static class CacheAdvisor {
        ...
        public static Object cache(
            ...
            CacheKey key = new CacheKey(thisObject, method.getName(), arguments);
            final CacheValue cacheResult = cache.get(key);

            if (Objects.nonNull(cacheResult) && cacheNotExpired(cacheResult, method)) {
                return cacheResult.value;
            }

            return invokeRealMethodAndPutInCache(superCall, key);
        }

        private static boolean cacheNotExpired(CacheValue cacheValue, Method method) {
        ...
        private static Object invokeRealMethodAndPutInCache(@SuperCall Callable<Object> superCall, CacheKey cacheKey) throws Exception {
